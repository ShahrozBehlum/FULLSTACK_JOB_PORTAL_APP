...
const JobListing = () => {
    ...
    const [selectedLocations, setSelectedLoactions] = useState([]);
    ...
    useEffect(() => {
        ...
        const matchesTitle = job => searchFilter.title.toLowerCase() === "" || job.title.toLowerCase().includes(searchFilter.title.toLowerCase());
    ...
    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
            ...
            <div className='w-full lg:w-1/4 bg-white px-4'>
                ...
                {
                    isSearched && (searchFilter.tilte !== "" || searchFilter.location !== "") && (
                        <>
